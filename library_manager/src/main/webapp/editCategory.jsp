...
<title>Chỉnh sửa thông tin thể loại</title>
...
<body>
	...
	<aside id="sidebar" class="sidebar">
		...
		<ul class="sidebar-nav" id="sidebar-nav">
			...
			<li class="nav-item">
				...
				<ul id="charts-nav" class="nav-content collapse collapse"
					data-bs-parent="#sidebar-nav">
					<li>
						<a href="/library_manager/authors">
							<i class="bi bi-circle"></i>
			...
			<li class="nav-item"><a class="nav-link "
				...
				<ul id="icons-nav" class="nav-content collapse show "
					data-bs-parent="#sidebar-nav">
					<li><a href="/library_manager/categories" class="active"> <i
	...
	<main id="main" class="main">
		...
		<div class="pagetitle">
			<div class="row">
				<div class="col-10">
					<h1>Chỉnh sửa thông tin thể loại</h1>
					<nav>
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active">Chỉnh sửa thông tin thể loại</li>
						</ol>
					</nav>
				</div>
				<div class="col-2"></div>
			...
			<div class="row">
				...
				<div class="card">
					<div class="card-body">
						<!-- Vertical Form -->
						<form class="row g-3"
							action="${pageContext.request.contextPath}/edit-category"
							method="post">
							<input type="hidden" name="categoryID" value="${category.category_id}">
							<div class="col-12 pt-3">
								<label for="input_name" class="form-label">Tên thể
									loại</label> <input type="text" class="form-control" id="input_name"
									name="name" value="${category.category_name}">
							</div>
							<div class="col-12">
								<label for="input_description" class="form-label">Mô tả</label>
								<input type="text" class="form-control" id="input_description"
									name="description" value="${category.category_description}">
							</div>
