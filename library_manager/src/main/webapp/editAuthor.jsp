...
<title>Chỉnh sửa thông tin tác giả</title>
...
<body>
	...
	<aside id="sidebar" class="sidebar">
		...
		<ul class="sidebar-nav" id="sidebar-nav">
			...
			<li class="nav-item"><a class="nav-link collapsed" href="/library_manager/dashboard">
					<i class="bi bi-grid"></i> <span>Trang chủ</span>
			</a></li>
			<!-- End Dashboard Nav -->
			...
			<li class="nav-item">
				<a class="nav-link " data-bs-target="#charts-nav" data-bs-toggle="collapse" href="#">
					...
					<span>Quản lý Tác giả</span>
					<i class="bi bi-chevron-down ms-auto"></i>
				</a>
				<ul id="charts-nav" class="nav-content collapse show"
					data-bs-parent="#sidebar-nav">
					<li>
						<a href="/library_manager/authors" class="active">
							<i class="bi bi-circle"></i>
							<span>Danh sách Tác giả</span>
						</a>
					</li>
				</ul>
			</li>
	...
	<main id="main" class="main">
		...
		<div class="pagetitle">
			<div class="row">
				<div class="col-10">
					<h1>Chỉnh sửa thông tin tác giả</h1>
					<nav>
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="books">Home</a></li>
							<li class="breadcrumb-item">Quản lý tác giả</li>
							<li class="breadcrumb-item">Danh sách tác giả</li>
							<li class="breadcrumb-item active">Chỉnh sửa thông tin tác giả</li>
						</ol>
					</nav>
				</div>
				<div class="col-2"></div>
		...
		<section class="section dashboard">
			<div class="row">
				...
				<script type="text/javascript">
            		alert('Thêm tác giả thành công!');
        		</script>
				<%
            		}
        		%>
				...
				<div class="card">
					<div class="card-body">
						<!-- Vertical Form -->
						<form class="row g-3"
							action="${pageContext.request.contextPath}/edit-author"
							method="post">
							<input type="hidden" name="authorID" value="${author.author_id}">
							<div class="col-12 pt-3">
								<label for="input_name" class="form-label">Tên tác
									giả</label> <input type="text" class="form-control" id="input_name"
									name="name" value="${author.author_name}">
							</div>
							<div class="col-12">
								<label for="input_biography" class="form-label">Địa chỉ</label>
								<input type="text" class="form-control" id="input_biography"
									name="biography" value="${author.author_biography}">
							</div>
