				...
				<div class="col-10">
					...
					<nav>
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active">Thêm tác giả</li>
						</ol>
					</nav>
				</div>
				<div class="col-2"></div>
					...
					<div class="card-body">
						...
						<form class="row g-3"
							...
							<div class="col-12 pt-3">
								<label for="input_name" class="form-label">Tên tác giả</label> <input type="text" class="form-control" id="input_name"
									name="name">
							</div>
							<div class="col-12">
								<label for="input_biography" class="form-label">Tiểu sử</label>
