				...
				<div class="col-10">
					...
					<nav>
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active">Quản lý tác giả</li>
						</ol>
					</nav>
				</div>
				<div class="col-2">
					<a href="addAuthor.jsp" type="">
						<button class="btn btn-success">Thêm tác giả</button>
					</a>
				</div>
			</div>
		</div>
		...
		<section class="section dashboard">
			<div class="row">
        		...
        		<script type="text/javascript">
            		alert('Xóa tác giả thành công!');
        		...
        		%>
        		<script type="text/javascript">
            		alert('Sửa tác giả thành công!');
            		window.location.href = 'authors';
        		</script>
        		<%
				}
				...
				<table class="table table-striped">
					...
					<tbody>
                		...
                		%>
						<tr>
							<th scope="row"><%= author.getAuthor_id() %></th>
							<td><%= author.getAuthor_name() %></td>
							<td><%= author.getAuthor_biography() %></td>
							<td>
                        		<form action="${pageContext.request.contextPath}/edit-author" method="get" style="display:inline; margin-right: 10px;">
                            		<input type="hidden" name="authorID" value="<%=author.getAuthor_id() %>">
                            		<button type="submit" class="btn btn-primary text-white">
                                		<i class="bi bi-pencil-square"></i>
                            		</button>
                        		</form>
								<form action="${pageContext.request.contextPath}/delete-author" method="post" style="display:inline;">
                            		<input type="hidden" name="authorID" value="<%= author.getAuthor_id() %>">
