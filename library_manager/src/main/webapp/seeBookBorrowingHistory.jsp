				...
				<div class="col-lg-12">
					<div class="card">
						<div class="card-body">
							...
							%>
							<div class="row">
								<div class="col-1">Họ và tên:</div>
								<div class="col-9"><%=member.getMember_name()%></div>
							</div>
							<div class="row">
								<div class="col-1">Số điện thoại:</div>
								<div class="col-9"><%=member.getMember_phone()%></div>
							</div>
							<div class="row">
								<div class="col-1">Email:</div>
								<div class="col-9"><%=member.getMember_email()%></div>
							</div>
							<div class="row">
								<div class="col-1">Địa chỉ:</div>
								<div class="col-9"><%=member.getMember_address()%></div>
							</div>
						</div>
					</div>
				</div>
