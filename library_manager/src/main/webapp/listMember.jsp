				...
				<div class="col-9">
					...
					<nav>
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item">Quản lý thành viên</li>
							<li class="breadcrumb-item active">Danh sách thành viên</li>
						</ol>
					</nav>
				</div>
				<div class="col-3 d-flex justify-content-center">
					<a href="addMember.jsp" type="" class="">
						<button class="btn btn-success">Thêm thành viên</button>
					</a>
				</div>
			</div>
		</div>
				...
				<table class="table table-striped">
					...
					<tbody>
						...
						<tr>
							...
							<td>
                        		<form action="${pageContext.request.contextPath}/edit-member" method="get" style="display:inline; margin-right: 10px;">
                            		<input type="hidden" name="memberID" value="<%=member.getMember_id() %>">
                            		<button type="submit" class="btn btn-primary text-white">
                                		<i class="bi bi-pencil-square"></i>
                            		</button>
                        		</form>
								<form action="${pageContext.request.contextPath}/delete-member" method="post" style="display:inline;">
                            		<input type="hidden" name="memberID" value="<%= member.getMember_id() %>">
