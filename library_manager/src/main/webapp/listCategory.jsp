				...
				<div class="col-10">
					...
					<nav>
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item">Quản lý thể loại</li>
							<li class="breadcrumb-item active">Danh sách thể loại</li>
						</ol>
					</nav>
				</div>
				<div class="col-2">
					<a href="addCategory.jsp" type="">
						<button class="btn btn-success">Thêm thể loại</button>
					</a>
				</div>
			</div>
		</div>
		...
		<section class="section dashboard">
			<div class="row">
        		...
        		<script type="text/javascript">
            		alert('Xóa thể loại thành công!');
        		...
        		%>
        		<script type="text/javascript">
            		alert('Sửa thể loại thành công!');
            		window.location.href = 'categories';
        		</script>
        		<%
				}
				...
				<table class="table table-striped">
					...
					<tbody>
                		...
                		%>
						<tr>
							<th scope="row"><%= category.getCategory_id() %></th>
							<td><%= category.getCategory_name() %></td>
							<td><%= category.getCategory_description() %></td>
							<td>
                        		<form action="${pageContext.request.contextPath}/edit-category" method="get" style="display:inline; margin-right: 10px;">
